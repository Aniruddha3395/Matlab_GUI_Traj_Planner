...
visualize_rob = false;
show_joint_angle_change = false;

global robot1 joint_angles_group joint_angles xyz_bxbybz_groups group_idx;
global plot_traj_arr idx;
joint_vel = ([ 98; 98; 100; 130; 140; 180; 180 ])*pi/180;
lim_on_failure = 1;
...
%     visualize_kuka_mm_test(joint_angles_group);
% end
