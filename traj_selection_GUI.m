...
%     [temp_pts,temp_normals,temp_faces] = curve_fit(strt_pt,end_pt,mold_v,mold_f,mold_n);  %Call the curve_fit function
    [temp_pts,temp_normals,temp_faces] = curve_fit(strt_pt,end_pt,mold_v_transformed,mold_f,mold_n_transformed);  %Call the curve_fit function
    ...
    if traj_successful
    %Plot the Points
    scatter3(points(strt_idx:end_idx,1),points(strt_idx:end_idx,2),points(strt_idx:end_idx,3),200,'*','b'); %Plot the Points
