...
if traj_successful
    ...
    plot_failed_traj = plot3(spline_pts(reach+1:end,1),spline_pts(reach+1:end,2),spline_pts(reach+1:end,3),'r','LineWidth',5); %Plot the failed traj's unsuccessful Points
    plot_failed_traj_arr = [plot_failed_traj_arr;plot_failed_traj];
end
